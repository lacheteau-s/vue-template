...
**Current [template version][13]:** `template/vuetify-pinia`

:information_source: This template is a combination of `template/vuetify` and `template/pinia`.
...
Simply copy the `template` folder to the desired location, and follow the template's [README][29] (⚠️ don't forget to edit the title and description).
...
[29]: template/README.md
[30]: https://github.com/Rich-Harris/degit
...
It [borrows concepts][31] from the [MVVM][32] pattern which I've had extensive experience with, working with [WPF][33], and [Xamarin/.NET MAUI][34].

My end goal here wasn't to merely learn Vue but to also understand the whole ecosystem around it (like [Vite][35]).
...
[31]: https://012.vuejs.org/guide/
[32]: https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93viewmodel
[33]: https://learn.microsoft.com/en-us/dotnet/desktop/wpf/overview
[34]: https://dotnet.microsoft.com/en-us/apps/maui
[35]: https://vite.dev/
