...
**Current [template version][13]:** `template/vuetify-router`

:information_source: This template is a combination of `template/vuetify` and `template/router`.
...
| Routing | [vue-router][28] | `template/router` |
