...
While `vuejs/create-vue` produces a generic template with a bunch of features pre-configured to fit most use cases, this template is an opinionated version, stripped-down to the bare essentials.
...
**Current [template version][12]:** `template/pinia-router`

:information_source: This template is a combination of `template/pinia` and `template/router`.

### Inherited features

| Feature | Libraries | Inherited from |
|---------|-----------|----------------|
| Code formatting | [prettier][13] | `template/base` |
| Linting | [eslint][14], [typescript-eslint][15], [eslint-plugin-vue][16], [eslint-plugin-prettier][17], [eslint-config-prettier][18] | `template/base` |
| State management | [pinia][19] | `template/pinia` |
| Routing | [vue-router][20] | `template/router` |
...
[19]: https://pinia.vuejs.org/
[20]: https://router.vuejs.org/

## How to use

Simply copy the `template` folder to the desired location, and follow the template's [README][21] (⚠️ don't forget to edit the title and description).
...
[21]: template/README.md
[22]: https://github.com/Rich-Harris/degit
...
It [borrows concepts][23] from the [MVVM][24] pattern which I've had extensive experience with, working with [WPF][25], and [Xamarin/.NET MAUI][26].

My end goal here wasn't to merely learn Vue but to also understand the whole ecosystem around it (like [Vite][27]).
...
[23]: https://012.vuejs.org/guide/
[24]: https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93viewmodel
[25]: https://learn.microsoft.com/en-us/dotnet/desktop/wpf/overview
[26]: https://dotnet.microsoft.com/en-us/apps/maui
[27]: https://vite.dev/
